...
export default function Cartogram(rootDOM, data, myWidth, myHeight, myYear, scaleType){
  
  //Internal variables
  //const W = rootDOM.clientWidth; //This seems like the better way to do it; not sure why you'd want to configure width and height.
  //const H = 600;
  const W = myWidth;
  const H = myHeight;
